...
//import { Test } from './PageQuickSidebarComponent.styles';

class PageQuickSidebarComponent extends PureComponent {
  constructor(props) {
    super(props);
  }

  componentWillMount = () => {
    console.log("PageQuickSidebarComponent will mount");
  };

  componentDidMount = () => {
    console.log("PageQuickSidebarComponent mounted");
  };

  componentWillReceiveProps = (nextProps) => {
    console.log("PageQuickSidebarComponent will receive props", nextProps);
  };

  componentWillUpdate = (nextProps, nextState) => {
    console.log("PageQuickSidebarComponent will update", nextProps, nextState);
  };

  componentDidUpdate = () => {
    console.log("PageQuickSidebarComponent did update");
  };

  componentWillUnmount = () => {
    console.log("PageQuickSidebarComponent will unmount");
  };
...
PageQuickSidebarComponent.propTypes = {
  // bla: PropTypes.string,
};

PageQuickSidebarComponent.defaultProps = {
  // bla: 'test',
};

export default PageQuickSidebarComponent;
