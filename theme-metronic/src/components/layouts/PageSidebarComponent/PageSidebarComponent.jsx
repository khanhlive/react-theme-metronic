...
//import { Test } from './PageSidebarComponent.styles';

class PageSidebarComponent extends PureComponent {
  constructor(props) {
    super(props);
  }

  componentWillMount = () => {
    console.log("PageSidebarComponent will mount");
    console.log($(this.menuRef));
  };

  componentDidMount = () => {
    console.log("PageSidebarComponent mounted");
  };

  componentWillReceiveProps = (nextProps) => {
    console.log("PageSidebarComponent will receive props", nextProps);
  };

  componentWillUpdate = (nextProps, nextState) => {
    console.log("PageSidebarComponent will update", nextProps, nextState);
  };

  componentDidUpdate = () => {
    console.log("PageSidebarComponent did update");
  };

  componentWillUnmount = () => {
    console.log("PageSidebarComponent will unmount");
  };
...
PageSidebarComponent.defaultProps = {
  // bla: 'test',
};
